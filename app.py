...
def webhook():
  ...
  if data['text'] == '8:00':
    ...
    msg = msg + 'Commons: '  + worksheet.cell(row+1, dv[0]).value + ' ' + worksheet.cell(row+1, dv[1]).value + ' ' + worksheet.cell(row+1, dv[2]).value + ' ' + worksheet.cell(row+1, dv[3]).value
    msg = msg + 'Harrington: '  + worksheet.cell(row+2, dv[0]).value + ' ' + worksheet.cell(row+2, dv[1]).value + ' ' + worksheet.cell(row+2, dv[2]).value + ' ' + worksheet.cell(row+2, dv[3]).value
    send_message(msg)
  elif data['text'] == '8:30':
    time.sleep(2)
    row = 13
    ...
    msg = msg + 'MSC: ' + worksheet.cell(row, dv[0]).value + ' ' + worksheet.cell(row, dv[1]).value + ' ' + worksheet.cell(row, dv[2]).value + ' ' + worksheet.cell(row, dv[3]).value
    msg = msg + 'Commons: '  + worksheet.cell(row+1, dv[0]).value + ' ' + worksheet.cell(row+1, dv[1]).value + ' ' + worksheet.cell(row+1, dv[2]).value + ' ' + worksheet.cell(row+1, dv[3]).value
    msg = msg + 'Sbisa: '  + worksheet.cell(row+2, dv[0]).value + ' ' + worksheet.cell(row+2, dv[1]).value + ' ' + worksheet.cell(row+2, dv[2]).value + ' ' + worksheet.cell(row+2, dv[3]).value
    send_message(msg)
